...
const INSIGHT_SEGMENT_POPOVER_MAP = {
  ...
  appointments: {
    ...
    当日: 'insightApptCancel',
    当日キャンセル: 'insightApptCancel',
    前日以降: 'insightApptCancel',
    前日以降キャンセル: 'insightApptCancel',
    無断: 'insightApptCancel',
    無断キャンセル: 'insightApptCancel',
    無断CX: 'insightApptCancel',
...
const INSIGHT_POPOVER_ROWS = {
  ...
  insightApptCancel: [
    { cancelType: '当日キャンセル', cancelDate: '2026/06/23', chartNo: 'C-3310', name: '松本 優', time: '10:30', apptDate: '2026/06/23' },
    { cancelType: '前日以降キャンセル', cancelDate: '2026/06/20', chartNo: 'C-3388', name: '井上 拓也', time: '13:00', apptDate: '2026/06/23' },
  ],
  insightApptNoShow: [
    { cancelType: '無断キャンセル', cancelDate: '2026/06/23', chartNo: 'C-3401', name: '木村 さくら', time: '16:00', apptDate: '2026/06/23', doctor: '田中 Dr' },
  ],
  insightApptPending: [
...
const CHART_LABEL_POPOVER_MAP = {
  ...
  当日: 'insightApptCancel',
  当日キャンセル: 'insightApptCancel',
  当日CXL: 'insightApptCancel',
  前日以降: 'insightApptCancel',
  前日以降キャンセル: 'insightApptCancel',
  前日以降CXL: 'insightApptCancel',
  無断: 'insightApptCancel',
  無断キャンセル: 'insightApptCancel',
  無断CX: 'insightApptCancel',
  未来院: 'insightApptPending',
