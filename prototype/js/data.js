...
const MOCK_DATA = {
  ...
  periodDetails: {
    ...
    '今月': {
      ...
      charts: {
        // 6/23時点 — 7〜12月は未来のため 0
        labels: ['1月', '2月', '3月', '4月', '5月', '6月', '7月', '8月', '9月', '10月', '11月', '12月'],
        insurance: [1920000, 2080000, 2040000, 2180000, 2340000, 2640000, 0, 0, 0, 0, 0, 0],
        selfPay: [880000, 960000, 1000000, 1040000, 1120000, 1280000, 0, 0, 0, 0, 0, 0],
        products: [240000, 260000, 280000, 300000, 320000, 360000, 0, 0, 0, 0, 0, 0],
        other: [80000, 70000, 60000, 50000, 40000, 0, 0, 0, 0, 0, 0, 0],
        visits: [720, 768, 752, 798, 824, 847, 0, 0, 0, 0, 0, 0],
        visitsFirst: [142, 158, 148, 162, 168, 178, 0, 0, 0, 0, 0, 0],
        visitsReFirst: [68, 72, 70, 76, 80, 84, 0, 0, 0, 0, 0, 0],
        visitsReturn: [510, 538, 534, 560, 576, 585, 0, 0, 0, 0, 0, 0],
        compareLabel: '前年同月',
        compareRevenue: [2680000, 2920000, 2850000, 3050000, 3180000, 3520000, 0, 0, 0, 0, 0, 0],
        compareVisits: [648, 692, 678, 712, 738, 762, 0, 0, 0, 0, 0, 0],
        highlightIndex: 5,
      },
      insights: [
